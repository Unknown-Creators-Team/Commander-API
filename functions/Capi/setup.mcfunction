...
scoreboard objectives add Capi:z dummy
...
scoreboard objectives add Capi:effAddTick dummy
scoreboard objectives add Capi:effAddLevel dummy
scoreboard objectives add Capi:effAddState dummy

scoreboard objectives add Capi:EcreateX dummy
scoreboard objectives add Capi:EcreateY dummy
scoreboard objectives add Capi:EcreateZ dummy
...
scoreboard objectives add Capi:attacks dummy
scoreboard objectives add Capi:damage dummy
scoreboard objectives add Capi:hurt dummy
scoreboard objectives add Capi:kill dummy
scoreboard objectives add Capi:death dummy
scoreboard objectives add Capi:killPlayer dummy
scoreboard objectives add Capi:deathPlayer dummy
