...
tickEvent.subscribe("main", ({ currentTick, deltaTime, tps }) => {
    try {
        world.getPlayers().forEach((PLAYER) => {
            ...
            player.score.set("Capi:inputX", Math.floor(player.inputInfo.getMovementVector().x * 100));
            player.score.set("Capi:inputY", Math.floor(player.inputInfo.getMovementVector().y * 100));
